...
def run_smoke_test():
    ...
    try:
        import dspyer  # noqa: F401
        from dspyer import (  # noqa: F401
            AgentTranspiler,
            dspyer_node,
            from_langgraph,
            self_correcting,
    ...
    try:
        from dspyer.graph import Graph, StatefulNode  # noqa: F401
        from dspyer.state import ImmutableState  # noqa: F401
